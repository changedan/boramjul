			...
			<div class="row">
				<div class="col-md-12 text-right">
					<ul class="social-icons">
						<nav>
							<a href="#" onclick="openlogin()" style="font-size: 20px; font-weight: bold;">로그인
								&nbsp;</a> <a href="#" onclick="openjoin()"
	...
	<div class="slider">
		<div class="flexslider">
			<ul class="slides">
				...
				ArrayList<String> arr2 = dao.selectBRIEF();
				%>
				<%
					for (int i = 0; i < 8; i++) {
				%>
...
hr {
	width: 85%;
		...
		<body>
			<div id="overjoin" class="overlayjoin">
				<div class="joinOver">
					...
					<form action="#" method="post">
						...
						<br> <label for="age" style="margin-left: 35px;">연령<br>
			...
			<div id="overlogin" class="overlaylogin">
				<div class="joinOver">
