        ...
        <div class="container">
            <nav id="nav_header">
                ...
                <div id="nav_login">
                    ...
                    <a href="#" onclick="openinfo()" style="font-size: 20px; font-weight: bold;">회원정보[닉네임:<%=dto.getMbNick()%>]
                    </a>
            ...
            <div class="flexslider">
                <ul class="slides">
                    <%
						for (int i = 0; i < 8; i++) {
					%>
                    <li class="slider-list"><a href="BookInfo?no=<%=bestseller.get(i).getBookSeq()%>">
                            <div class="overlay"></div> <img src="<%=bestseller.get(i).getBookCover()%>" alt="">
                            <div class="slider-title"><%=bestseller.get(i).getBookTitle()%></div>
                            <div class="slider-berief"><%=bestseller.get(i).getBookBrief()%></div>
        ...
        <div class="joinOver">
            ...
            <form action="JoinCon" method="post">
                ...
                <br> <label for="gen" style="margin-left: 35px;">성별<br>
                    <input name="mb_gender" type="radio" style="margin-left: 50px;" name="성별" value="M">남 <input name="mb_gender" type="radio" name="성별" value="F">여
                </label><br> <br> <label for="age" style="margin-left: 35px;">연령<br>
                    <input id="age" name="mb_age" type="radio" style="margin-left: 50px;" value="10">10대 <input id="age" name="mb_age" type="radio" value="20">20대 <input id="age" name="mb_age" type="radio" value="30">30대<br> <input id="age" name="mb_age" type="radio" style="margin-left: 50px;" value="40">40대 <input id="age" name="mb_age" type="radio" value="50">50대 <input id="age" name="mb_age" type="radio" value="60">60대 이상
                </label><br> <br>
                <hr>
                <p id="pw_result"></p>
    ...
    <div id="overlogin" class="overlaylogin" style="z-index: 2000;">
        <div class="joinOver">
            ...
            <form action="LoginCon" method="post">
                <input id="loginId" class="mainInfologin" type="text" name="mb_id" placeholder="ID를 입력해주세요"> <input id="loginPw" class="mainInfologin" type="password" name="mb_pw" placeholder="비밀번호를 입력해주세요"> <br>
                <hr>
